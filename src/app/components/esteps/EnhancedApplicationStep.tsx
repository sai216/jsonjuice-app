...
import { ApplicationDetailsManager } from '../esteps/ApplicationDetailsManager';
...
const mockApplications: CandidateApplication[] = [
  {
    ...
    linkedInUrl: 'https://linkedin.c@/johnsmith',
  ...
  },
  {
    ...
    linkedInUrl: 'https://linkedin.c@/sarahjohnson',
    rating: 3,
  ...
  },
  {
    ...
    linkedInUrl: 'https://linkedin.c@/emilydavis',
    rating: 2,
